...
static AiurdemuxCodecStruct aiurdemux_videocodec_tab[] ={
  ...
  {VIDEO_JPEG, 0, "JPEG", "image/jpeg, parsed = (boolean)true"},
  {VIDEO_MJPG, VIDEO_MJPEG_FORMAT_A, "Motion JPEG format A", "image/jpeg, parsed = (boolean)true"},
  {VIDEO_MJPG, VIDEO_MJPEG_FORMAT_B, "Motion JPEG format B", "image/jpeg, parsed = (boolean)true"},
  {VIDEO_MJPG, VIDEO_MJPEG_2000, "Motion JPEG 2000", "image/x-j2c"},
  {VIDEO_MJPG, 0, "Motion JPEG format unknow", "image/jpeg, parsed = (boolean)true"},
