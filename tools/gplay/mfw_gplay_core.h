...
typedef struct
{
    ...
    fsl_player_s8 creation_date[METADATA_ITEM_MAX_SIZE_SMALL];
    fsl_player_s8 genre[METADATA_ITEM_MAX_SIZE_SMALL];
    fsl_player_s8 albumartist[METADATA_ITEM_MAX_SIZE_LARGE];
    ...
    fsl_player_s8 location_latitude[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s8 location_longtitude[METADATA_ITEM_MAX_SIZE_LARGE];
