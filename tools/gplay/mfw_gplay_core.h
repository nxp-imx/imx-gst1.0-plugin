...
typedef struct
{
    ...
    fsl_player_s8 copyright[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s8 comment[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s8 date[METADATA_ITEM_MAX_SIZE_SMALL];
    fsl_player_s8 composer[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s8 director[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s8 info[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s8 creator[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s8 producer[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s8 performer[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s8 requirement[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s8 songwritor[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s8 moviewritor[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s8 tool[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s8 description[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s8 latitude[METADATA_ITEM_MAX_SIZE_SMALL];
    fsl_player_s8 longitude[METADATA_ITEM_MAX_SIZE_SMALL];
    fsl_player_s8 author[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s8 collection[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s8 publisher[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s8 software[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s8 keywords[METADATA_ITEM_MAX_SIZE_LARGE];
    fsl_player_s32 track_num;
