...
typedef enum
{
  SUBTITLE_H_ALIGN_LEFT,
  SUBTITLE_H_ALIGN_CENTER,
  SUBTITLE_H_ALIGN_RIGHT,
  SUBTITLE_H_ALIGN_POSITION
} SubtitleHAlign;

typedef enum
{
  SUBTITLE_V_ALIGN_BASELINE,
  SUBTITLE_V_ALIGN_BOTTOM,
  SUBTITLE_V_ALIGN_TOP,
  SUBTITLE_V_ALIGN_POSITION,
  SUBTITLE_V_ALIGN_CENTER
} SubtitleVAlign;
